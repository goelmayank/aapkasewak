     ...
     <table width="101%"  border="0" cellspacing="10" cellpadding="5"> 
       ...
       <tr> 
         <td align="left" valign="top" class="border1"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"> 
          ...
          <tr> 
            <td> 
              <form name="productForm"  method="post" action="product_form.php" enctype="multipart/form-data" onsubmit="javascript : return validateProductForm();"> 
                          ...
                          <tr> 
                           ...
                           <tr> 
                            ...
                            <td colspan="2" valign="top">
                              <textarea name="short_desc" cols="55" rows="5" class="input" id="short_desc"></textarea>
                            </td> 
                          </tr> 
                          <tr>
