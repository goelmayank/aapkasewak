...
if ( isset( $_POST['Submit'] ) )
{
	...
	move_uploaded_file($_FILES['productImage']['tmp_name'], $target_path);
 	...
 	$sql="update image set category='$category',imagename='$file_name',imagedesc='$description' where id=$productid";
			    ...
			    <td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2"> 
                            ...
                            <tr> 
                             ...
                             <br /> 
                              ...
                              <td align='center' valign="top" bgcolor="#FFFFFF" class="Title"><img src='../img/goa/<?php echo $imagename?>' height='65' width='80'></td> 
                            </tr> 
                            <tr> 
