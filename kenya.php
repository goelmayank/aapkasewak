        ...
        <div class="container">
           <!-- <ul class="breadcrumb">
            ...
            <div class="booking-item-details">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    ...
                                    <div class="row row-no-gutter" id="popup-gallery">
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/kenya/kenya1.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/kenya/kenya1.jpg" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL de luxe" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/kenya/kenya2.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/kenya/kenya2.jpg" alt="Image Alternative text" title="hotel EDEN MAR suite" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <!--<div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/kenya/kenya3.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/kenya/kenya3.jpg" alt="Image Alternative text" title="The pool" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/kenya/kenya5.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/kenya/kenya5.jpg" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/kenya/kenya6.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/kenya/kenya6.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/kenya/kenya7.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/kenya/kenya7.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                    </div>
              ...
              <tr>
                <td align="center" class="orangeText"><strong><u>Kenya Safari Exprerience</u> </strong></td>
              </tr>
              <tr>
                <td align="center" class="style25">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" class="style25"><strong><u>06 Nights / 07  Days</u></strong></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="88%"><div align="justify"><span class="style31"><strong>1 Nairobi</strong></span><br />
                    </div></td>
                    <td width="4%">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><div align="justify" class="meter">Arrive at the airport and you are met and  transferred to your hotel. Overnight. </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top"></td>
                  ...
                  <tr>
                    ...
                    <td class="style31"><strong>2 Aberdare</strong><strong> National Park</strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td class="meter"><div align="justify" class="meter">
                        <div align="justify">Depart&nbsp;  after&nbsp; breakfast&nbsp; to&nbsp; Aberdares &nbsp;Country Club nestled on  the slopes of Mweiga Hill . All rooms and cottages are comfortable with private  bathroom facilities and have&nbsp; spectacular views of the plains below and  the Aberdare Mountains  to the west and Mount Kenya to the &nbsp;east.  The &nbsp;club serves as a gateway to the popular 'tree lodge, The&nbsp; Ark,  (Children below the age of 7 years are not allowed) Set in the &nbsp;heart of  &nbsp;the &nbsp;Aberdare &nbsp;National &nbsp;Park, this unique game lodge  overlooks a &nbsp;floodlit&nbsp; waterhole and salt lick which attracts a host  of Wildlife.Overnight at&nbsp; The Ark Lodge or similar (B,L,D) (Driving time  Appx.3 Hours).</div>
                    </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="style31"><strong>3 Sweetwaters Camp</strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><div align="justify" class="meter">After&nbsp;  breakfast, &nbsp;you &nbsp;will&nbsp; be &nbsp;transferred &nbsp;to  &nbsp;Aberdare &nbsp;country &nbsp;to collect &nbsp;your&nbsp;&nbsp; baggage  &nbsp;and &nbsp;&nbsp;drive&nbsp;&nbsp; to &nbsp;your &nbsp;hotel&nbsp;situated  &nbsp;in &nbsp;the shadow&nbsp; of&nbsp; &nbsp;Mt Kenya, Kenya's highest  mountain. Arrive in time for lunch at your Camp. Depart&nbsp;for an afternoon  game drive. Dinner and overnight at Sweetwater's Tented Camp or similar. (B,L,D) </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td class="style31"><strong>4 Lake &nbsp;Nakuru &nbsp;National&nbsp; Park</strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td><div align="justify" class="meter">Drive &nbsp;via &nbsp;Nairobi &nbsp;or&nbsp;  direct&nbsp; to &nbsp;Lake Nakuru National Park famous as the home to thousands  of lesser and greater flamingo. This park also provides &nbsp;sanctuary  &nbsp;for&nbsp; Rothschild &nbsp;giraffe,&nbsp; rhino and leopard. Arrive in  time for lunch at your lodge. Afternoon game drive until sunset. Overnight at Lake Nakuru Lodge (B,L,D)</div></td>
                  </tr>
                  ...
                  <tr>
                    <td><strong>Day</strong></td>
                    <td class="style31"><strong>5 Masai Mara National Game Reserve</strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td class="style31"><div align="justify" class="meter">Depart&nbsp; after  &nbsp;breakfast&nbsp; and &nbsp;drive&nbsp; via&nbsp; Narok &nbsp;to &nbsp;the  &nbsp;Masai&nbsp; Mara National Reserve offering wonderful scenery and plenty  of game. &nbsp;It is perhaps the only region &nbsp;left &nbsp;in &nbsp;Kenya where the  visitor may see animals &nbsp;in&nbsp; the &nbsp;same &nbsp;super-abundance as  existed a century ago. Arrive &nbsp;in &nbsp;time &nbsp;for &nbsp;lunch  &nbsp;at your camp. Afternoon game drive until<br />
sunset. All&nbsp; meals and overnight at Siana Intrepids  Camp or similar. (B,L,D).</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td><strong>Day</strong></td>
                    <td class="style31"><strong>6 Masai Mara National G.R. Siana Intrepids Camp or  similar</strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td><div align="justify" class="meter">Morning &nbsp;and &nbsp;afternoon &nbsp;game  &nbsp;drives.&nbsp;All&nbsp; meals &nbsp;and &nbsp;overnight at Siana  Intrepids&nbsp;&nbsp; Camp &nbsp;or&nbsp; similar&nbsp;&nbsp;(B,L,D).  &nbsp;{&nbsp;Today &nbsp;you have an opportunity to go on a spectacular  Optional balloon ride &nbsp;across the Masai Mara. The &nbsp;BALLOON SAFARI  adventure b&nbsp;egins &nbsp;in the pre-dawn hours. The magnificent view  of&nbsp; the park &nbsp;is thrilling. &nbsp;Towards the &nbsp;end &nbsp;of  &nbsp;the &nbsp;safari, you&nbsp; rise&nbsp; to&nbsp; a &nbsp;height&nbsp;  of&nbsp; 1500&nbsp; feet &nbsp;for&nbsp; a panoramic&nbsp; view of the twisting  Mara River and the savannah below. After an hour &nbsp;or &nbsp;so in the air,  your safari &nbsp;finishes with a flourish: a champagne breakfast in the bush,  cooked on the balloon's burners. Pls note that this is an optional&nbsp; extra  which can be arranged at the time &nbsp;of &nbsp;booking &nbsp;this &nbsp;trip  - full refund given if this balloon does not take off}.</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td class="style31"><strong>7 Departure out </strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
       
                    <td><div align="justify" class="meter">Depart after breakfast and drive to Nairobi, Kenya's  colourful capital city (5hours drive). On arrival you will be dropped off at a  city centre hotel or have transit lunch in Nairobi and proceed to the airport. (B )</div></td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td align="center" class="meter"><strong>Extend  Your Trip To Tanzania OR South    Africa<br />
Highlights of the Tour : 5 days of Game Viewing </strong></td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
                    <td class="meter">&nbsp;</td>
