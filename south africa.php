           ...
           <!-- <ul class="breadcrumb">
            ...
            <div class="booking-item-details">
                <header class="booking-item-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h2 class="lh1em">South Africa</h2>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    ...
                                    <div class="row row-no-gutter" id="popup-gallery">
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/south africa/southafrica1.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/south africa/southafrica1.jpg" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL de luxe" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/south africa/southafrica2.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/south africa/southafrica2.jpg" alt="Image Alternative text" title="hotel EDEN MAR suite" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <!--<div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/south africa/southafrica3.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/south africa/southafrica3.jpg" alt="Image Alternative text" title="The pool" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/south africa/southafrica4.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/south africa/southafrica4.jpg" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/south africa/southafrica5.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/south africa/southafrica5.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/south africa/southafrica6.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/south africa/southafrica6.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="ml20">
                            <div class="booking-item-meta">
                                ...
                                <tr>
                <td align="center" class="orangeText"><U>Spectacular South Africa</U> </td>
              </tr>
              <tr>
                <td align="center">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" class="style25"><strong><U>08 Nights / 09 Days</U></strong></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="88%"><div align="justify"><span class="style31">1 Arrive  Cape Town</span><br />
                    </div></td>
                    <td width="4%">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><div align="justify" class="meter">Arrive the mother city  Cape Town by flight via Johannesburg. Cape Town is one of the  most beautiful cities of the world. Check in hotel. </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top"></td>
                  ...
                  <tr>
                    ...
                    <td class="style31">2 Cape Town  (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td class="meter"><div align="justify" class="meter">
                        <div align="justify">Morning enjoy a city tour of Cape Town. Visit the Iconic Table   Mountain with cable car (  weather permiting ). On a clear day you will get some of the best views from  the top here. Enjoy some of the best coastal drives to Clifton and Sea Point., cruise on the  waterfront etc. </div>
                    </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="style31">3 Cape Town (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><div align="justify" class="meter">Full day tour to enjoy visit to the Cape of Good  Hope or Cape Point &ndash; the romantic meeting place of the Indian and Atlantic  Oceans, enjoy a glass bottom boat ride to the Seal Island, Hout Bay, Cape of  Good Hope Reserve, Kirstenbosch Botanical Gardens, Penguin Colon in Simons  town. Evening at hotel. </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td class="style31">4 Cape  Town-Garden Route-Knysna  (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td><div align="justify" class="meter">Travel by private vehicle to the famous and  scenic Garden Route  &ndash; enroute visit Hermanus, Post Office Tree, Mossel Bay.  Check in Hotel. Evening enjoy a relaxing cruise on the Knysna Lagoon. </div></td>
                  </tr>
                  ...
                  <tr>
                    <td><strong>Day</strong></td>
                    <td class="style31">5 Ostrich  Capital &ndash; Oudtshoorn  (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td class="style31"><div align="justify" class="meter">Today enjoy a full day visit to Oudtshoorn &ndash;  visit the Ostrich Farm and see the world larges bird &ndash; Ostrich and the bird  that lays the largest egg. Visit Cango Caves, Cheetah Ranch and have some great  opportunity to get your picture with the Cheetahs. Evening back to Knysna. </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td><strong>Day</strong></td>
                    <td class="style31">DAY 6  Knysna-Suncity  (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td><div align="justify" class="meter">Transfer to George airport for flight to Johannesburg. Arrive and  transfer to Suncity &ndash; the resort town of South    Africa. Check in hotel. Time at leisure. . </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td class="style31">7 Suncity   (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
       
                    <td><div align="justify" class="meter">Full day free to enjoy the various water sports  and leisure activities here. OR take an optional tour to the nearby Pilanesberg  Wildlife Reserve to see some of the big boys of the jungle at close quarters. </div></td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td class="style31">8 Suncity-Johannesburg   (B)</td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
                    <td class="meter"><div align="justify">Travel to Johannesburg.  Enroute visit one of the biggest Gold Mines at the Gold Reef Tour &ndash; descend  into the mine and enjoy a tour. Evening at Johannesburg.</div></td>
                  </tr>
                  ...
                  <tr>
                    <td height="18" align="center" valign="top"><strong>Day</strong></td>
                    <td class="style31">9 Johannesburg-India   (B)</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="18" align="center" valign="top">&nbsp;</td>
                    <td class="meter">Transfer to the  airport for your flight back home.</td>
                  </tr>
                </table></td>
              </tr
