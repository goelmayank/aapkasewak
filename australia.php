        ...
        <div class="container">
           <!-- <ul class="breadcrumb">
            ...
            <div class="booking-item-details">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    ...
                                    <div class="row row-no-gutter" id="popup-gallery">
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/australia/australia1.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/australia/australia1.jpg" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL de luxe" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/australia/australia2.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/australia/australia2.jpg" alt="Image Alternative text" title="hotel EDEN MAR suite" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <!--<div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/australia/australia3.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/australia/australia3.jpg" alt="Image Alternative text" title="The pool" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/australia/australia7.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/australia/australia7.jpg" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/australia/australia5.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/australia/australia5.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/australia/australia6.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/australia/australia6.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="ml20">
                            <div class="booking-item-meta">
                                ...
                                <h2><small class="alert-info">05 Nights & 06 Days</small></h2>
                                   <tr>
                <td height="18"><p align="center"><span class="orangeText style14"><u>AUSTRALIAN HIGHLIGHTS </u></span><br />
                </p></td>
              </tr>
              <tr>
                <td align="center">&nbsp;</td>
              ...
              <tr>
                <td align="center"><span class="style15"><u>10 Days / 09 Nights</u></span></td>
              </tr>
              <tr>
                <td align="center"><span class="style17"><u>3N GOLD COAST / 3N CAIRNS / 3N SYDNEY </u> </span></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="8%" align="center" valign="top"><strong>Day 1</strong></td>
                    <td width="88%"><div align="justify" class="meter">Arrive Brisbane Airport and SIC transfer to Gold Coast Hotel. Check-in  and Day Free. Overnight. </div></td>
                    <td width="4%">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><div align="justify" class="meter">Breakfast.  Return SIC transfer to Dreamworld OR Seaworld OR Movieworld&nbsp; (Choice of 1 Theme Park). Overnight</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><div align="justify" class="meter">Breakfast.  Check-out and depart by SIC Transfer for Brisbane/Goldcoast Airport for your  onward flight. Arrive Cairns Airport and transfer by SIC to your Hotel. Check-in  &amp; Overnight.</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><div align="justify"><span class="meter">Early  morning 30Minutes Courtesy SIC HOTAIR Balloon flight with Champagne Breakfast  (Includes Aviation Levy of AUD30/Pax), then transfer for Full Day Kuranda Tour  with Tjapuakai Cultural Park + 1Way SkyRail + 1Way Scenic Rail (Sky 4)  Overnight&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><div align="justify" class="meter">Breakfast.  Full Day SIC Great Adventure OUTER Barrier Reef Cruise Tour with Tropical  Lunch. Overnight</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td valign="top"><strong> &nbsp;Day </strong>7</td>
                    <td><span class="meter">Breakfast.  Check-out and Depart for Cairns Airport by SIC transfer for your onward  flight.  Arrive Sydney &amp; Transfer  by SIC to your Hotel and Check-in. Overnight</span></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" valign="top"><strong>Day 8 </strong></td>
                    <td><div align="justify" class="meter">Breakfast.  This Morning we proceed by SIC for Half Day Sydney City Tour including Opera  House, Sydney Harbour Bridge, Manly Beach, etc (APT # S1-Complimentry &amp; NON  Refundable). After Tour get down at King Street Stop, Darling Harbour &amp;  Proceed to Aquarium to exchange SYDNEY 3-in-1Pass for Entry to Syd Aquarium +  Unlimited 1Day  Ride on Syd MonoRail  + Syd Tower &amp; OzTrek + Complimentry Glass Bottom Boat Ride at Aquarium.  Evening proceed on OWN to King Street Wharf # 5, Darling Harbour by  1850-1900hrs to join Sydney Show Boat STANDARD Indian Dinner Cruise (No  Transfers - No Cruising WED/SUN).(Supplement cost of AUD10 Per Person EXTRA to  Upgrade to DELUXE/PREMIUM Seating at Showboat Cruise) Use this day unlimited  MonoRail pass to travel from nearest station to Hotel &amp; Darling Harbour.  Overnight</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td align="center" valign="top"><strong>Day 9 </strong></td>
                    <td><div align="justify" class="meter">Breakfast.  Choice of 1 Full Day SIC Tour - Blue Mountains Tour + Light Lunch + 2Unit Scenic Ride (1Way  Cableway + 1Way Railway) with Wildlife Park (APT # S15+LR - Compulsory &amp; NON  Refundable) OR Blue   Mountains +  Jenolan Caves (APT # S32 - Compulsory &amp; NON Refundable, Operates on  Mon/Tue/Thu/Sat). Overnight</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td align="center" valign="top"><strong>Day10 </strong></td>
                    <td><div align="justify" class="meter">Breakfast.  Check Out of Hotel. SIC transfer to Sydney Airport for onward flight. </div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
