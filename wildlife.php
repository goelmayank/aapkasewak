           ...
           <!-- <ul class="breadcrumb">
            ...
            <div class="booking-item-details">
                ...
                <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    ...
                                    <div class="row row-no-gutter" id="popup-gallery">
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/wildlife/wild1.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/wildlife/wild1.jpg" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL de luxe" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/wildlife/wild2.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/wildlife/wild2.jpg" alt="Image Alternative text" title="hotel EDEN MAR suite" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <!--<div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/wildlife/wild3.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/wildlife/wild3.jpg" alt="Image Alternative text" title="The pool" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/wildlife/wild4.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/wildlife/wild4.jpg" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/wildlife/wild5.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/wildlife/wild5.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/wildlife/wild6.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/wildlife/wild6.jpg"" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="ml20">
                            <div class="booking-item-meta">
                                ...
                                <table width="99%" border="0">
                                  ...
                                  <tr>
                                    <td width="9%" align="center" valign="top"><strong>Day  </strong></td>
                                    <td width="87%"><div align="justify" class="style23"><strong>1 Arrival at Port Blair and transfer to respective hotel</strong></div></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td>
                                    <td class="meter">Arrival at Port Blair  in the morning and transfer to respective hotel and rest till afternoon. In the  afternoon proceed for Harbour Cruise (Viper Island),  covering seven ports by boats, and u can see one of the big floating dry dock,  the island naval harbour and mainland going vessel harbour. Late evening  witness the enthralling Sound and Light Show at Cellular Jail - where the  heroic saga of the Indian freedom struggle is brought alive. Over night stay at  respective Hotel / Resort at Port Blair.<br /></td>
                                    <td width="4%"></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td>
                                  ...
                                  <tr>
                                    ...
                                    <td align="center"><div align="justify" class="style23"><strong>2 Full- Day excursion to Coral Island, Visit Ross Island</strong></div></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td><div align="justify" class="meter">Sightseeing of North and South   Goa. In the evening tour of the fishing villages that are a part  of Goa's rich cultural heritage. Artisans  display their skills whilst the village dancers whirl to the music of a local  band. Overnight in the hotel.</div></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"><strong>Day </strong></td>
                                    <td><div align="justify" class="style23"><strong>3 Early morning departure by inter-island ferry to Havelock Island (54 kms by sea from Port Blair) </strong>&nbsp; </div></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top">&nbsp;</td>
                                    <td valign="top" class="meter">Early morning departure  by inter-island ferry to Havelock   Island (54 kms by sea  from Port Blair). Enjoy your afternoon at the World Famous   Radha Nagar   Beach (Beach number 7).  Over night stay at respective Hotel / Resort at Havelock Island. </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td align="center" valign="top"><strong>Day</strong></td>
                                    <td valign="top"><span class="style23"><strong>4 Entire Morning at leisure </strong></span></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td>
                                    <td valign="top"></td>
                                  ...
                                  <tr>
                                    <td align="center" valign="top">&nbsp;</td>
                                    <td>Entire Morning at  leisure. Sail for Port Blair in the noon. Upon return from Havelock Island,  transfer to Hotel. Over night stay at respective Hotel / Resort at Port Blair</td>
                                    <td></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"><strong>Day</strong>
                                    </td>
                                    <td valign="top"><span class="style23"><strong>5 Full-Day "City Tour" of Port Blair - covering Cellular Jail, Chatham Saw Mill  </strong></span></td>
                                  </tr>
                               
                                  <tr>
                                    <td align="center" valign="top">&nbsp;</td>
                                <td>After breakfast, start off for a full-day "City Tour" of Port Blair - covering Cellular Jail, Chatham Saw Mill (one of the oldest & largest in Asia- Now closed), Forest Museum, Mini Zoo, Fisheries (Marine) Museum & Water Sports Complex. Afternoon is free for shopping and other own activities. Over night stay at respective Hotel / Resort at Port Blair.</td>
                                  </tr>
                                  
                                  <tr>
                                    <td align="center" valign="top"><strong>Day</strong></td>
                                    <td><strong>6 Return Hotel </strong></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td><td>Return home with memories of the ultimate holidays.</td>
                                  </tr>
                                  
                                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <strong><td align="center">03  Nights &amp; 04 Days</td></strong>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    <td align="center" valign="top"><strong>Day</strong></td>
                    <td class="style13"><strong>1 Arrival at Port Blair and transfer to respective hotel </strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td class="style13"><span class="meter">Arrival at Port Blair  in the morning and transfer to respective hotel and rest till afternoon. In the  afternoon proceed for Harbour Cruise (Viper Island),  covering seven ports by boats, and u can see one of the big floating dry dock,  the island naval harbour and mainland going vessel harbour. Late evening  witness the enthralling Sound and Light Show at Cellular Jail - where the  heroic saga of the Indian freedom struggle is brought alive. Over night stay at  respective Hotel / Resort at Port Blair</span></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    <td align="center" valign="top"><strong>Day</strong></td>
                    <td class="style13"><strong>3 Full-Day &quot;City  Tour&quot; of Port Blair - covering Cellular Jail, Chatham Saw Mill </strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td class="meter"><div align="justify">After breakfast, start  off for a full-day &quot;City Tour&quot; of Port Blair - covering Cellular  Jail, Chatham Saw Mill (one of the oldest &amp; largest in Asia- Now closed), Forest Museum,  Mini Zoo, Fisheries (Marine) Museum &amp; Water Sports Complex. Afternoon is  free for shopping and other own activities. Over night stay at respective Hotel  / Resort at Port Blair.</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                  ...
                  <tr>
                    <td align="center" valign="top"><strong>Day</strong></td>
                    <td class="style13"><strong>4 Return Hotel </strong></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">&nbsp;</td>
                    <td><div align="justify" class="meter"> Return home with  memories of the ultimate holidays.</div></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top"></td>
