                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    ...
                                    <div class="row row-no-gutter" id="popup-gallery">
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/leh/leh-ladakh1.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/leh/leh-ladakh1.jpg" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL de luxe" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/leh/leh-ladakh2.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/leh/leh-ladakh2.jpg" alt="Image Alternative text" title="hotel EDEN MAR suite" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <!--<div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/leh/leh-ladakh3.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/leh/leh-ladakh3.jpg" alt="Image Alternative text" title="The pool" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/leh/leh-ladakh4.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/leh/leh-ladakh4.jpg" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/leh/leh-ladakh5.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/leh/leh-ladakh5.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                                            <a class="hover-img popup-gallery-image" href="img/leh/leh-ladakh6.jpg" data-effect="mfp-zoom-out">
                                                <img src="img/leh/leh-ladakh6.jpg" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" /><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="ml20">
                            <div class="booking-item-meta">
                                <h2><small class="alert-info">3 Nights / 4 Days</small></h2>
                                <table width="99%" border="0">
                                  
                                  <tr>
                                    <td width="9%" align="center" valign="top"><strong>Day  </strong></td>
                                    <td width="87%"><div align="justify" class="style23"><strong>1 Goa</strong></div></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td>
                                    <td class="meter">On arrival transfer to the hotel. Rest of the  day to relax on the beach. Overnight in the hotel.<br /></td>
                                    <td width="4%"></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td>
                                  ...
                                  <tr>
                                    ...
                                    <td align="center"><div align="justify" class="style23"><strong>2 Goa</strong></div></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  ...
                                  <tr>
                                    <td align="center" valign="top"><strong>Day </strong></td>
                                    <td><div align="justify" class="style23"><strong>3 Goa </strong>&nbsp; </div></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top">&nbsp;</td>
                                    <td valign="top" class="meter">Full day to enjoy the Beach. Ovenight in the  hotel </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td align="center" valign="top"><strong>Day</strong></td>
                                    <td valign="top"><span class="style23"><strong>4 Goa</strong></span></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top"></td>
                                    <td valign="top"></td>
                                  ...
                                  <tr>
                                    <td align="center" valign="top">&nbsp;</td>
                                    <td>Flight for onward destination.</td>
                                    <td></td>
                                  </tr>
                                  <tr>
                                    <td align="center" valign="top">&nbsp;</td>
